...
df = df.loc[:, ['tamanho', 'quartos', 'valor', 'tipo_area','preco]].sample(n=60, random_state=0, weights = 'valorcasa')
...
utils.plot_results_linear(X_train, y_train, regressor, 'Regressão Linear (Conj. de Treinamento)')

# Visualizando os resultados do conjunto de testes
utils.plot_results_linear(X_test, y_test, regressor, 'Regressão Linear (Conj. de Testes)')